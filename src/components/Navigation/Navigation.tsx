        ...
        <div className="navigation">
            <div className="navigation__main">
                ...
                <ul className="navigation__menu">
                    ...
                    <li onClick={onClick} onMouseEnter={handleMouseEnter("vision", "Vision page")} onMouseLeave={handleMouseLeave} className="navigation__menu-item"><NavLink className={({ isActive }) => (isActive ? 'active' : '')} to="/vision">Vision</NavLink></li>
